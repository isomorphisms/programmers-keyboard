...
#define USB_PRODUCT "Phone call-control HID experiment"
...
/*
 * Consumer Control is the important distinction from the keyboard-only
 * firmware elsewhere in this repository.  The report is one 16-bit Consumer
 * usage, so the device can emit Play/Pause (0x00cd) and Media Select Telephone
 * (0x008c) without pretending they are F-keys.
 */
